...
namespace {
    ...
    TEST(BoardRotationTest, 3x3_270) {
        constexpr auto rot = []() {
            auto val = Go::Util::rotate(board_3x3());
    ...
    TEST(BoardRotationTest, 3x3_360) {
        constexpr auto rot = []() {
            auto val = Go::Util::rotate(board_3x3());
    ...
    TEST(BoardRotationTest, 4x4_270) {
        constexpr auto rot = []() {
            auto val = Go::Util::rotate(board_4x4());
            val = Go::Util::rotate(val);
            return Go::Util::rotate(val);
    ...
    TEST(BoardRotationTest, 4x4_360) {
        constexpr auto rot = []() {
            auto val = Go::Util::rotate(board_4x4());
