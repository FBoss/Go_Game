...
TYPED_TEST_P(BoardTest, DefaultConstructible) {
	EXPECT_TRUE(std::is_default_constructible<decltype(this->mBoard)>::value);
}
...
TYPED_TEST_P(BoardTest, Destructible) {
	EXPECT_TRUE(std::is_destructible<decltype(this->mBoard)>::value);
}
...
REGISTER_TYPED_TEST_CASE_P(
    BoardTest, // The first argument is the test case name.
                         // The rest of the arguments are the test names.
	DefaultValue, 
	GetOutOfRangeNegative,
	GetOutOfRangePositive,
	RandomReadWrite,

	DefaultConstructible,
	EqualOperatorDefaultConstructible,
	EqualOperator,
	NotEqualOperatorDefaultConstructible,
	NotEqualOperator,
	MoveConstructible,
	MoveAssignable,
	Destructible,
