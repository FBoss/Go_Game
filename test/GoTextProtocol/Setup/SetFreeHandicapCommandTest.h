...
TEST(SetFreeHandicapCommand, OutputWithoutId5Vertices) {
  ...
  auto test = Go::GoTextProtocol::to_string(Go::GoTextProtocol::SetFreeHandicapCommand<5>{
      {Go::GoTextProtocol::Vertex{0, 0}, Go::GoTextProtocol::Vertex{1, 1}, Go::GoTextProtocol::Vertex{2, 2},
       Go::GoTextProtocol::Vertex{3, 3}, Go::GoTextProtocol::Vertex{4, 4}}});
