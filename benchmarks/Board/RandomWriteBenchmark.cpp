...
BENCHMARK_TEMPLATE(RandomWrite, Go::UnorderedMapBoard<0,0> );
BENCHMARK_TEMPLATE(RandomWrite, Go::UnorderedMapBoard<4,4> );
BENCHMARK_TEMPLATE(RandomWrite, Go::UnorderedMapBoard<9,9> );
BENCHMARK_TEMPLATE(RandomWrite, Go::UnorderedMapBoard<13,13> );
BENCHMARK_TEMPLATE(RandomWrite, Go::UnorderedMapBoard<17,17> );
BENCHMARK_TEMPLATE(RandomWrite, Go::UnorderedMapBoard<19,19> );
BENCHMARK_TEMPLATE(RandomWrite, Go::UnorderedMapBoard<100,100>);
