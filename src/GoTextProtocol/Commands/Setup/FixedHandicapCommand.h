...
struct FixedHandicapCommand : public Command {
  ...
  constexpr explicit FixedHandicapCommand(const unsigned int id, const int number_of_stones) noexcept
      : Command{id, "fixed_handicap"}, number_of_stones{number_of_stones} {};
  constexpr explicit FixedHandicapCommand(const int number_of_stones) noexcept
      : Command{std::nullopt, "fixed_handicap"}, number_of_stones{number_of_stones} {};
};
