...
struct PlaceFreeHandicapCommand : public Command {
  ...
  constexpr explicit PlaceFreeHandicapCommand(unsigned int id, const int number_of_stones) noexcept
      : Command{id, "place_free_handicap"}, number_of_stones{number_of_stones} {};
  constexpr explicit PlaceFreeHandicapCommand(const int number_of_stones) noexcept
      : Command{std::nullopt, "place_free_handicap"}, number_of_stones{number_of_stones} {};
};
